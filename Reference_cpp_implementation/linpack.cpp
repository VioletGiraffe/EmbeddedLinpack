...
int main() {
  ...
  avgMflops /= N_RUNS;
  std::cout << "Average MFLOPS: " << avgMflops << std::endl;
  std::cout << "Min MFLOPS: " << minMflops << std::endl;
  std::cout << "Max MFLOPS: " << maxMflops << std::endl;
}
...
# define LDA ( N + 1 )
  ...
  std::cout << "\n";
  std::cout << "LINPACK_BENCH\n";
  std::cout << "  C version\n";
  std::cout << "\n";
  std::cout << "  The LINPACK benchmark.\n";
  std::cout << "  Language: C\n";
  std::cout << "  Datatype: Double precision real\n";
  std::cout << "  Matrix order N               =" << N << std::endl;
  std::cout << "  Leading matrix dimension LDA = " << LDA << std::endl;
...
*/
  ...
  {
    std::cout << "\n";
    std::cout << "LINPACK_BENCH - Fatal error!\n";
    std::cout << "  The matrix A is apparently singular.\n";
...
*/
  ...
  std::cout <<  ( "\n" );
  std::cout <<  ( "     Norm. Resid      Resid           MACHEP         X[1]          X[N]\n" );
  std::cout <<  ( "\n" );
  std::cout << ("  ");
  std::cout << (residn, 14);
  std::cout << ("  ");
  std::cout << (resid_max, 14);
  std::cout << ("  ");
  std::cout << (eps, 14);
  std::cout << ("  ");
  std::cout << (b[0], 14);
  ...
  std::cout <<  ( "\n" );
  std::cout <<  ( "      Factor     Solve      Total     MFLOPS       Unit      Cray-Ratio\n" );
  std::cout <<  ( "\n" );
  for(int i =0; i<6;i++) {
      std::cout << ("  ");
      std::cout << (time[i], 9);
...
*/
{
  const auto timeStamp = std::chrono::high_resolution_clock::now().time_since_epoch();
  return std::chrono::duration<floating_point_t, std::ratio<1, 1>>(timeStamp).count();
}
/******************************************************************************/
